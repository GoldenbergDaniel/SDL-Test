...
const char *shaders_frag_src = "#version 410 core in vec3 color; out vec4 frag_color; uniform vec4 u_color = vec4(0); void main() {   vec4 final_color = u_color + vec4(color, 1.0);   frag_color = final_color; } ";
