...
typedef GL_Object Object;
typedef GL_Texture2D Texture2D;
typedef GL_VertexLayout VertexLayout;
...
Object gl_create_vertex_buffer(void *data, u32 size)
{
  u32 id;
  glGenBuffers(1, &id);
...
inline
void gl_bind_vertex_buffer(Object *buffer)
{
...
Object gl_create_index_buffer(void *data, u32 size)
{
  u32 id;
  glGenBuffers(1, &id);
...
inline
void gl_bind_index_buffer(Object *buffer)
{
...
Object gl_create_vertex_array(u8 attrib_count)
{
  u32 id;
...
inline
void gl_bind_vertex_array(Object *vertex_array)
{
  GL_ASSERT(glBindVertexArray(vertex_array->id));
}
...
void gl_set_vertex_layout(Object *vertex_array, u32 data_type, u32 count)
{
  u8 type_size;
  switch (data_type)
  {
...
Texture2D gl_load_texture2d(const i8 *path)
{
  Texture2D tex;
...
inline
void gl_bind_texture2d(Texture2D *texture)
{
...
void gl_clear(Vec4F color)
{
  glClearColor(color.r, color.g, color.b, color.a);
  glClear(GL_COLOR_BUFFER_BIT);
}

void gl_draw(Object *vertex_array, Shader *shader)
{
